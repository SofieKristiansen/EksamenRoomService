                    ...
                    foreach ($produkter as $produkt) {
                        ...
                        <div class=" d-flex flex-column justify-content-between">
                            <div class="col-6 mb-3 text-start">
                                <h2 class="brødtekst text-primærtekstfarve fw-bold fs-2 pt-4 ps-5"
                                    style="line-height: 1;">Oversigt</h2>
                            </div>

                            <div class="col-12 mb-3 text-start">
                                <h2 class="brødtekst text-primærtekstfarve text-bold fs-2 pt-4 ps-5"
                                    style="line-height: 1;"><?php echo $produkt->prodNavn ?></h2>
                            </div>

                            <div class="d-flex justify-content-end align-items-end flex-grow-1 col-12">
                                <div class="brødtekst text-primærtekstfarve fs-2 fw-bold me-5 mt-5 mb-3"
                                     id="total-pris"> Total:
            ...
            <div class="card shadow bg-kortfarve mt-5 pt-5" style="border-radius: 70px;">
                <div class="row">
                    ...
                    <div class="col-6 text-start">
                        <h2 class="brødtekst text-primærtekstfarve fw-bold fs-2 ps-5" style="line-height: 1;">
                            Værelsesnummer</h2>
                            ...
                            <div class="form-check p-3 d-flex justify-content-between align-items-center">
                                ...
                                <a href="#">
                                    <button type="button" id="betalKnappen"
                                            class="btn btn-lg rounded-pill btn-primærknap fs-3 brødtekst me-5"
                                            style="width: 160px"
                    ...
                    <div class="modal-content border-outlinefarve">
                        ...
                        <div class="modal-body text-primærtekstfarve brødtekst">
                            <div class="modal-body">
                                ...
                                <p class="fs-4 fw-medium">Tak for din bestilling, din mad er på vej. Vi håber du
                                    nyder din mad. Beløbet opkræves ved check ud af hotellet.</p>
                            </div>
                    ...
                    <div class="modal-content border-outlinefarve">
                        ...
                        <div class="modal-body text-primærtekstfarve brødtekst">
                            <div class="modal-body">
                                ...
                                <p class="fs-4 fw-medium">Tak for din bestilling, din mad er på vej. Betaling sker
                                    når maden bliver leveret. Vi håber du nyder din mad.</p>
                                ...
                                <div class="hstack">
                                    ...
                                    <img src="img/mastercard.png" alt="mastercard"
                                         style="width: 45px; height: auto"> <img src="img/mobilepay.png"
                                                                                 alt="mobilepay"

    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-outlinefarve">
            ...
            <div class="modal-footer">
                ...
                <a href="Indkøbskurv.php" class="btn btn-primary me-3 btn-lg rounded-pill btn-primærknap text-sekundærekstfarve border-outlinefarve" style="width: 150px;">Bestil mere</a>
            </div>
